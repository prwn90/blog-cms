			  ...
			  <div class="col-lg-6">
				...
				<div class="col-lg-6">
					<div class="btn-group pull-right">
						...
						<a href="<?php echo base_url(); ?>admin/articles" class="btn btn-danger">Close</a>
				</div>
			  </div>
			</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="form-group">
							...
							<input class="form-control" type="text" name="title" value="<?php echo set_value('title'); ?>" placeholder="Article Title" />
						</div>
						<div class="form-group">
